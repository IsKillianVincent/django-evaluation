    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to=accounts.models.user.user_directory_path, verbose_name='Profile Photo')),
                ('is_employer', models.BooleanField(default=False, verbose_name='Is Employer?')),
                ('is_driven', models.BooleanField(default=False, verbose_name='Is Driven?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('level', models.CharField(choices=[('A1', 'Beginner (A1)'), ('A2', 'Elementary (A2)'), ('B1', 'Intermediate (B1)'), ('B2', 'Upper Intermediate (B2)'), ('C1', 'Advanced (C1)'), ('C2', 'Proficient (C2)'), ('FLUENT', 'Fluent')], max_length=10, verbose_name='Proficiency Level')),
